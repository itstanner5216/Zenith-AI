...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg bg-[var(--bg-depth-1)] p-1 text-[var(--text-dim)] border border-[var(--border-defined)]",
      className
    )}
    {...props}
  />
