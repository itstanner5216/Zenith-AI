...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent shadow-sm transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(14,210,247,0.4)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-depth-2)] disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-[rgba(14,210,247,0.5)] data-[state=checked]:border-[var(--text-accent)] data-[state=checked]:shadow-[0_0_6px_rgba(14,210,247,0.3)] data-[state=unchecked]:bg-[var(--bg-depth-1)] data-[state=unchecked]:border-[rgba(14,210,247,0.2)]",
      className
    )}
    {...props}
    ref={ref}
