...
export const ToggleSetting: React.FC<ToggleSettingProps> = ({
  ...
  <div className="flex items-center justify-between py-2.5 border-b border-[var(--border-subtle)] last:border-b-0 group hover:bg-[rgba(14,210,247,0.02)] rounded-md px-1 -mx-1 transition-colors duration-150">
    <div className="flex-1 mr-4">
      <div className="font-medium text-[var(--text-normal)] text-sm leading-snug">
        {name}
      </div>
      <div className="text-xs text-[var(--text-dim)] mt-0.5 leading-relaxed opacity-60">
        {description}
      </div>
    </div>
...
export const TextAreaSetting: React.FC<TextAreaSettingProps> = ({
  ...
  <div className="py-2">
    ...
    <div className="text-xs text-[var(--text-dim)] mb-1 opacity-60">
      {description}
    </div>
    <textarea
      value={value}
