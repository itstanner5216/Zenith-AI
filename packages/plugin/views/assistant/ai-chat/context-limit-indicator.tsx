  ...
  return (
    <div className="mt-2 space-y-2 flex">
      <div className="relative">
        <div
          ...
          ${
            isOverLimit
              ...
              : "border border-[rgba(14,210,247,0.12)] text-[var(--text-dim)] hover:border-[rgba(14,210,247,0.25)]"
          }`}
        ...
        <div
          className={`absolute left-0 bottom-full mb-1 w-72 bg-[var(--bg-depth-3)] border border-[rgba(14,210,247,0.15)] rounded-md shadow-[0_4px_16px_rgba(0,0,0,0.6),0_0_8px_rgba(14,210,247,0.12)] transition-opacity z-20 ${
            isTooltipOpen
