          ...
          <ReactMarkdown
            ...
            components={{
              ...
              code: ({ children, ...props }) => (
                <code
                  {...props}
                  className="inline-code bg-[var(--bg-depth-1)] border border-[rgba(14,210,247,0.15)] px-1.5 py-0.5 rounded text-[var(--text-accent)] text-[0.8em] font-mono"
                >
                  {children}
                </code>
              ),
              ...
              h1: ({ children, ...props }) => (
                <h1 {...props} className="text-lg font-bold bg-gradient-to-r from-[var(--gradient-blue)] to-[var(--gradient-lavender)] bg-clip-text text-transparent mt-3 mb-1 border-b border-[rgba(14,210,247,0.15)] pb-1">{children}</h1>
              ),
              h2: ({ children, ...props }) => (
              ...
              blockquote: ({ children, ...props }) => (
                <blockquote {...props} className="border-l-2 border-[rgba(14,210,247,0.4)] pl-3 my-2 text-[var(--text-dim)] opacity-85 bg-gradient-to-r from-[rgba(32,28,41,0.5)] to-transparent rounded-r-md py-1">{children}</blockquote>
              ),
              ...
              thead: ({ children, ...props }) => (
                <thead {...props} className="bg-[var(--bg-depth-1)] border-b border-[rgba(14,210,247,0.2)]">{children}</thead>
              ),
              th: ({ children, ...props }) => (
              ...
              td: ({ children, ...props }) => (
                <td {...props} className="px-2 py-1.5 text-[var(--text-normal)] border-b border-[rgba(14,210,247,0.06)]">{children}</td>
              ),
              tr: ({ children, ...props }) => (
