        ...
        <div className="flex items-center justify-between border-b border-[rgba(14,210,247,0.08)] pb-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-2 py-1 text-xs rounded border border-[rgba(14,210,247,0.15)] text-[#45aaff] hover:bg-[rgba(14,210,247,0.06)] hover:border-[rgba(14,210,247,0.45)] hover:text-[#0fb6d6] active:scale-[0.97] transition-all duration-150"
              disabled={isApplying}
            >
              Discard
            </button>
