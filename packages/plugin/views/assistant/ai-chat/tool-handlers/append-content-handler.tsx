...
export function AppendContentHandler({
  ...
  return (
    <div className="flex flex-col space-y-4 p-4 bg-[#191621] border border-[rgba(14,210,247,0.08)] rounded-md shadow-elevation-md">
      <div className="text-[#bebebe]">
        {toolInvocation.args.message ||
          "Would you like to append the following content?"}
      </div>

      <div className="bg-[#0d0b12] p-3 rounded border border-[rgba(14,210,247,0.05)]">
