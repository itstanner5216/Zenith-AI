...
function ToolInvocationHandler({
  ...
  return (
    <motion.div
      className="my-1.5 rounded-md overflow-hidden border border-[var(--border-defined)] shadow-elevation-md bg-[var(--bg-depth-3)] transition-all duration-200"
    ...
    >
      ...
      <div className="flex items-center gap-2 px-3 py-2 bg-[var(--bg-depth-1)] border-b border-[var(--border-defined)]">
        ...
        <span
          className="w-1.5 h-1.5 rounded-full bg-[var(--text-accent)] shadow-glow-cyan-sm animate-pulse flex-shrink-0"
