  ...
  return (
    <div className="p-3 space-y-3 bg-[var(--bg-depth-3)] border border-[rgba(14,210,247,0.08)] rounded-md shadow-[0_2px_8px_rgba(0,0,0,0.4)]">
      ...
      <div className="text-xs space-y-1">
        ...
        <div className="p-2 bg-[var(--bg-depth-1)] text-[var(--text-dim)] font-mono text-xs max-h-32 overflow-y-auto whitespace-pre-wrap rounded border border-[rgba(14,210,247,0.06)]">
