...
const Tiptap: React.FC<TiptapProps> = ({
  ...
  return (
    <div
      className="tiptap-editor relative rounded-md border border-[rgba(14,210,247,0.12)] bg-[var(--bg-depth-1)] transition-all duration-150 focus-within:border-[rgba(14,210,247,0.45)] focus-within:shadow-[0_0_0_1px_rgba(14,210,247,0.15),0_0_8px_rgba(14,210,247,0.08)]"
      onKeyDown={onKeyDown}
    >
      <EditorContent editor={editor} />
      {isEmpty && editor && (
        <div className="absolute left-[10px] top-[10px] pointer-events-none text-[var(--text-dim)] text-sm select-none opacity-40 italic">
          Type @ to mention files, folders, or tags, or / for commands...
        </div>
      )}
    </div>
