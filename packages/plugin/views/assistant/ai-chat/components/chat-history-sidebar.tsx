  ...
  return (
    <StyledContainer>
      <div className={tw("w-64 border-r border-[rgba(14,210,247,0.05)] p-2 flex flex-col h-full bg-[#0d0b12]")} role="navigation" aria-label="Chat history">
        <div className={tw("text-xs font-semibold bg-gradient-to-r from-[#45aaff] to-[#b4a5ff] bg-clip-text text-transparent uppercase mb-2 tracking-wider")}>
          Chat History
        </div>
                ...
                <div
                  ...
                  className={tw(
                    ...
                    activeChatId === session.id
                      ? "bg-[rgba(14,210,247,0.1)] border-l-2 border-[#0fb6d6] shadow-[0_0_6px_rgba(14,210,247,0.2),0_2px_8px_rgba(0,0,0,0.4)]"
                      : "border-l-2 border-transparent hover:bg-[#191621] hover:border-[rgba(14,210,247,0.15)] hover:shadow-elevation-md"
                  )}
