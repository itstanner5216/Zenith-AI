...
export const ObsidianCodeBlock: React.FC<ObsidianCodeBlockProps> = ({
  ...
  return (
    <div className="obsidian-code-block-wrapper relative group my-2.5 rounded-md overflow-hidden shadow-[0_4px_16px_rgba(0,0,0,0.5),0_0_1px_rgba(14,210,247,0.08)]">
      {/* Header bar */}
      <div className="flex items-center justify-between px-3 py-1.5 bg-[var(--bg-depth-1)] border border-b-0 border-[rgba(14,210,247,0.12)] rounded-t-md">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-medium transition-all duration-200 select-none border ${
            copied
              ...
              : "text-[var(--text-dim)] opacity-0 group-hover:opacity-100 hover:text-[var(--text-accent)] hover:bg-[rgba(14,210,247,0.08)] border-transparent hover:border-[rgba(14,210,247,0.2)]"
          }`}
      ...
      <div
        ref={containerRef}
        className="obsidian-rendered-code bg-[var(--bg-depth-1)] border border-t-0 border-[rgba(14,210,247,0.12)] rounded-b-md overflow-x-auto"
      />
    </div>
  );
};
