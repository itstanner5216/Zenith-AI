...
export const UndoButton: React.FC<UndoButtonProps> = ({ record, plugin, onUndo }) => {
  ...
  return (
    <Button
      ...
      size="sm"
      variant="outline"
      className={tw("flex items-center gap-2 text-xs border-[rgba(255,183,77,0.3)] text-[#ffb74d] hover:bg-[rgba(255,183,77,0.08)] shadow-[0_0_8px_rgba(255,183,77,0.2)] hover:shadow-[0_0_12px_rgba(255,183,77,0.35)] active:scale-[0.97] transition-all duration-150 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[rgba(14,210,247,0.45)]")}
