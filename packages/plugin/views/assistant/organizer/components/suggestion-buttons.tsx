...
export const ExistingFolderButton: React.FC<{
  ...
  <BaseFolderButton
    {...props}
    className="bg-[rgba(14,210,247,0.08)] text-[var(--text-normal)] hover:bg-[rgba(14,210,247,0.18)] hover:text-[var(--text-accent)] border border-solid border-[var(--border-accent)] hover:border-[var(--border-active)] hover:shadow-[var(--glow-cyan-sm)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--border-active)]"
  />
);
...
export const NewFolderButton: React.FC<{
  ...
  <BaseFolderButton
    {...props}
    className="bg-[rgba(14,210,247,0.03)] text-[var(--text-dim)] hover:bg-[rgba(14,210,247,0.12)] hover:text-[var(--text-accent)] border border-dashed border-[var(--border-accent)] hover:border-[var(--border-active)] hover:shadow-[var(--glow-pink-sm)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--border-active)]"
  />
);
