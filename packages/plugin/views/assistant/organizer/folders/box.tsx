...
export const SimilarFolderBox: React.FC<SimilarFolderBoxProps> = ({
      ...
      <div className="flex items-center gap-3 text-sm">
        <div className="flex gap-2">
          <button
            onClick={handleRetry}
            disabled={loading}
            className="px-3 py-1.5 bg-[rgba(14,210,247,0.15)] text-[var(--text-accent)] border border-[rgba(14,210,247,0.4)] rounded hover:bg-[rgba(14,210,247,0.25)] hover:border-[rgba(14,210,247,0.8)] disabled:opacity-50 transition-colors duration-200"
          >
            {loading ? "Retrying..." : "Retry"}
          </button>
          <button
            onClick={() => setError(null)}
            className="px-3 py-1.5 border border-[rgba(14,210,247,0.1)] text-[var(--text-normal)] rounded hover:bg-[rgba(14,210,247,0.08)] transition-colors duration-200"
          >
            Dismiss
          </button>
        </div>
  ...
  return (
    <div className="bg-[var(--bg-depth-3)] text-[var(--text-normal)] p-4 border border-[rgba(14,210,247,0.08)] rounded-md shadow-[0_2px_8px_rgba(0,0,0,0.4)] hover:border-[rgba(14,210,247,0.15)] transition-all duration-150">
      {renderContent()}
    </div>
  );
};
