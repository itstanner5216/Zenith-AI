      ...
      <div className="flex items-center gap-3 text-sm">
        <div className="flex gap-2">
          <button
            onClick={handleRetry}
            disabled={loading}
            className="px-3 py-1.5 bg-[rgba(14,210,247,0.15)] text-[#0fb6d6] border border-[rgba(14,210,247,0.45)] rounded hover:bg-[rgba(14,210,247,0.25)] hover:border-[rgba(14,210,247,0.45)] disabled:opacity-50 transition-colors duration-200"
          >
            {loading ? "Retrying..." : "Retry"}
          </button>
          <button
            onClick={() => setError(null)}
            className="px-3 py-1.5 border border-[rgba(14,210,247,0.08)] text-[#bebebe] rounded hover:bg-[rgba(14,210,247,0.08)] transition-colors duration-200"
          >
            Dismiss
          </button>
        </div>
