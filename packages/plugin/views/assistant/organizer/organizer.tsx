...
export const AssistantView: React.FC<AssistantViewProps> = ({
  ...
  if (!isLicenseValid) {
    return (
      <div className={tw("flex flex-col h-full")}>
        <div
          className={tw(
            "flex gap-2 items-center px-3 py-2 border-b border-[rgba(14,210,247,0.08)] bg-[var(--bg-depth-1)]"
          )}
        >
  ...
  return (
    <div className={tw("flex flex-col h-full overflow-y-auto")}>
      ...
      <div
        className={tw(
          "flex gap-2 items-center px-3 py-2 border-b border-[rgba(14,210,247,0.1)] bg-[var(--bg-depth-1)] sticky top-0 z-10"
        )}
      >
        <RefreshButton onRefresh={refreshContext} />
        <div
