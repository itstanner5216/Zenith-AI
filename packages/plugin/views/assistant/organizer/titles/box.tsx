...
const ErrorDisplay: React.FC<{ message: string; onRetry: () => void }> = ({
  ...
  <div className="space-y-2">
    ...
    <button onClick={onRetry} className="px-3 py-1.5 bg-[rgba(14,210,247,0.15)] text-[#0fb6d6] border border-[rgba(14,210,247,0.45)] rounded hover:bg-[rgba(14,210,247,0.25)] transition-colors duration-200 text-sm">Retry</button>
  </div>
);
