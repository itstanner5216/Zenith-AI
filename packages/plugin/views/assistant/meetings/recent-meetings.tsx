        ...
        {recordings.map((recording) => {
          ...
          return (
            <div
              ...
              className={tw(
                "bg-[var(--bg-depth-3)] border border-[var(--border-defined)] rounded p-3 hover:bg-[rgba(14,210,247,0.06)] hover:border-[var(--border-accent)] shadow-[0_2px_8px_rgba(0,0,0,0.4)] transition-all duration-200"
              )}
            >
