...
export function OnboardingWizard({ plugin, onComplete }: OnboardingWizardProps) {
  ...
  return (
    <StyledContainer>
      <motion.div
        className={tw("max-w-xl mx-auto bg-[#191621] p-6 rounded-xl border border-[rgba(14,210,247,0.08)] shadow-[0_8px_40px_rgba(0,0,0,0.7),0_0_16px_rgba(14,210,247,0.08)]")}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      >
        <h2 className={tw("text-xl font-bold mb-6 bg-gradient-to-r from-[#45aaff] to-[#b4a5ff] bg-clip-text text-transparent")}>
          {step === 0
          ...
          <div
            ...
            <div>
              ...
              <input
                ...
                className={tw("w-full bg-[#0d0b12] border border-[rgba(14,210,247,0.08)] rounded px-3 py-2 text-[#bebebe] focus:outline-none focus:border-[rgba(14,210,247,0.45)] focus:ring-1 focus:ring-[rgba(14,210,247,0.15)] transition-all duration-150")}
              />
            </div>
        ...
        {step === 2 && (
          <div className={tw("mb-6 space-y-4")}>
            ...
            <h4 className={tw("text-lg font-semibold text-center bg-gradient-to-r from-[#45aaff] to-[#b4a5ff] bg-clip-text text-transparent")}>You're ready to go!</h4>
            
            <p className={tw("text-center text-[#bebebe]")}>
              Zenith-AI is now connected and ready to work with your vault.
            </p>
            
            <div className={tw("bg-[#0d0b12] p-4 rounded-md border border-[rgba(14,210,247,0.08)] shadow-[inset_0_1px_3px_rgba(0,0,0,0.4)]")}>
              <h4 className={tw("font-medium text-sm mb-2 bg-gradient-to-r from-[#45aaff] to-[#b4a5ff] bg-clip-text text-transparent")}>We'll create these folders for you:</h4>
